...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://ema.doox.cloud/assets/css/bootstrap.min.css" />

    <link rel="stylesheet" type="text/css" href="https://ema.doox.cloud/backend/assets/css/style.css" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="https://ema.doox.cloud/assets/js/bootstrap.min.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="https://ema.doox.cloud/favicon.ico" type="image/x-icon" /> 
